...
function displayAllWeather(finalres) {
  ...
  cartona += `
        ...
        <div class="item">
          <div class="d-flex justify-content-center align-items-center day">
            <p>${getDayName(finalres.current.last_updated)}</p>
            <p>${
              finalres.current.last_updated.slice(8, 10) +
              getMonth(finalres.current.last_updated)
            }</p>
          </div>
          <div class="content position-relative">
            <p class="my-3 city">${
              inputsearch.value
                .toLowerCase()
                .includes(finalres.location.name.toLowerCase())
                ? finalres.location.name
                : finalres.location.name + "," + finalres.location.country
            }</p>
            ...
            <h2 class="text-center">
              ...
              )} "width="50px" class="position-absolute image" /> 
              <span class="my-3 status">${
      ...
      <div class="col-md-4 avv">
        <div class="item ">
          ...
          <div class="content text-center">
            ...
            <h5>  ${finalres.forecast.forecastday[1].day.maxwind_mph}</h5>
            <div class="icon-span d-flex flex-column">
            <img src="${displayWeatherIcon(
              finalres.forecast.forecastday[1].day.condition.icon
            )} "width="50px" class="position-absolute image2 mb-3" /> 
              <span class="my-3 status"> ${
      ...
      <div class="col-md-4   day3">
        <div class="item ">
          ...
          <h5 >  ${finalres.forecast.forecastday[2].day.maxwind_mph}</h5> 
         
         
            <div class="icon-span d-flex flex-column">
            <img src="${displayWeatherIcon(
              finalres.forecast.forecastday[2].day.condition.icon
            )} "width="50px" class="position-absolute image3 " /> 
              <span class="my-3 status"> ${
  ...
  cartona += `
        ...
        <div class="item">
          <div class="d-flex justify-content-around align-content-center day">
            ...
            <p>${
              data.current.last_updated.slice(8, 10) +
              getMonth(data.current.last_updated)
            }</p>
          </div>
          <div class="content position-relative">
            <p class="my-3 city">${
              inputsearch.value
                .toLowerCase()
                .includes(data.location.name.toLowerCase())
                ? data.location.name
      ...
      <div class="col-md-4 avv">
        <div class="item ">
          ...
          <div class="content text-center">
            ...
            <h5>  ${data.forecast.forecastday[1].day.maxwind_mph}</h5>
            <div class="icon-span d-flex flex-column">
            <img src="${displayWeatherIcon(
      ...
      <div class="col-md-4   day3">
        <div class="item ">
          ...
          <h5 >  ${data.forecast.forecastday[2].day.maxwind_mph}</h5> 
